...
export const INITIAL_BOOKINGS: Booking[] = [
  {
    ...
    date: 'Oct 24, 2023',
    image: 'https://picsum.photos/seed/ubud/800/400',
    paidAmount: 120,
    onSiteAmount: 35,
    photos: [],
    driver: {
      name: 'Wayan Sudarsana',
      photo: 'https://picsum.photos/seed/driver/200/200',
      plate: 'DK 1234 ABC',
  ...
  },
  {
    ...
    date: 'Oct 25, 2023',
    image: 'https://picsum.photos/seed/rafting/800/400',
    paidAmount: 85,
    onSiteAmount: 10,
    photos: [],
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/bali/800/400',
    paidAmount: 850,
    onSiteAmount: 150,
    photos: [],
    currentDay: 1,
